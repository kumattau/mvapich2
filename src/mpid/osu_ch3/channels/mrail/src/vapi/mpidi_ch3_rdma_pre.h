...
typedef struct MPIDI_CH3I_MRAIL_VC_t
{
...
#ifdef ONE_SIDED
    VAPI_qp_hndl_t qp_hndl_1sc;
    VAPI_qp_prop_t qp_prop_1sc;
    ...
    u_int16_t next_packet_expected;                 /* for sequencing (starts at 0) */
    u_int16_t next_packet_tosend;                   /* for sequencing (starts at 0) */
#ifdef RDMA_FAST_PATH
    ...
    VAPI_sr_desc_t put_desc;
    VAPI_sg_lst_entry_t put_sg_entry;

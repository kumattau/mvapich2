...
#ifndef _IBV_ARCH_64_H
#define _IBV_ARCH_64_H
...
#error Either _IA32_ or _IA64_ or _X86_64_ or _EM64T_ or MAC_OSX or PPC64 must be defined
#endif
...
#error Only one of _IA32_ and MAC_OSX can be defined
    ...
    || defined(_PPC64_) || defined(MAC_OSX))

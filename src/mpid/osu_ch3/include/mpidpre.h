...
typedef enum MPIDI_CH3_Pkt_type
{
    ...
    MPIDI_CH3_PKT_ACCUMULATE_RNDV,  /*7*/
    MPIDI_CH3_PKT_GET_RNDV,         /*8*/
...
/* Newly for OSU-MPI2: origin rts is the same type as eager send  */
...
/* Newly defined packet type for OSU-MPI2 */
...
#endif */
    /********** OSU-MPI2 ************/
    /* couter is added to vc to hold the number of issued rma operations ***/
    uint32_t rma_issued;
    /****** end of OSU-MPI2 *********/
...
#define MPIDI_CH3_WIN_DECL int16_t outstanding_rma;

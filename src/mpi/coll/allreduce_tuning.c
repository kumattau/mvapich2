...
int MV2_set_allreduce_tuning_table(int heterogeneity)
{
  ...
  if (mv2_use_indexed_tuning || mv2_use_indexed_allreduce_tuning) {
	...
	MPIU_Memcpy(mv2_allreduce_indexed_thresholds_table[i], table_ptrs[i],
      ...
      MV2_COLL_TUNING_ADD_CONF     (allreduce, 28, 5, GEN2__RI2__28PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (allreduce, 28, 5, GEN2_CMA__RI2__28PPN)
	...
	PSM__INTEL_XEON_E5_2695_V3_2S_28_INTEL_HFI_100__2PPN;
      ...
      mv2_allreduce_indexed_table_ppn_conf[2] = 28;
      mv2_size_allreduce_indexed_tuning_table[2] = 4;
      mv2_allreduce_indexed_tuning_table mv2_tmp_allreduce_indexed_thresholds_table_28ppn[] =
	PSM__INTEL_XEON_E5_2695_V3_2S_28_INTEL_HFI_100__28PPN;
      table_ptrs[2] = mv2_tmp_allreduce_indexed_thresholds_table_28ppn;
	...
	MPIU_Memcpy(mv2_allreduce_indexed_thresholds_table[i], table_ptrs[i],
      ...
      /* Jade/Opal Table */
      MV2_COLL_TUNING_START_TABLE  (allreduce, 2)
      ...
      MV2_COLL_TUNING_ADD_CONF     (allreduce, 4,  5, PSM__INTEL_XEON_PHI_7250_68_INTEL_HFI_100__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (allreduce, 16, 4, PSM__INTEL_XEON_PHI_7250_68_INTEL_HFI_100__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (allreduce, 64, 3, PSM__INTEL_XEON_PHI_7250_68_INTEL_HFI_100__16PPN)
      MV2_COLL_TUNING_FINISH_TABLE (allreduce)
    }
    else {
      /*Sierra Table*/

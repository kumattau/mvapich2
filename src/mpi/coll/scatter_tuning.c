...
int MV2_set_scatter_tuning_table(int heterogeneity)
{
	...
	return 0;
        ...
        MV2_COLL_TUNING_ADD_CONF     (scatter, 4,  1, GEN2__RI2__4PPN)
        MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 4,  1, GEN2_CMA__RI2__4PPN)
        MV2_COLL_TUNING_ADD_CONF     (scatter, 8,  4, GEN2__RI2__8PPN)
        MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 8,  4, GEN2_CMA__RI2__8PPN)
        MV2_COLL_TUNING_ADD_CONF     (scatter, 16, 4, GEN2__RI2__16PPN)
        MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 16, 4, GEN2_CMA__RI2__16PPN)
	...
	*/
	...
	MPIU_Memcpy(mv2_scatter_indexed_thresholds_table[i], table_ptrs[i],
      ...
      MV2_COLL_TUNING_ADD_CONF     (scatter, 1,  4, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 2,  5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__2PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 4,  5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 8,  5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__8PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 16, 5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 24, 5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__24PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 48, 5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__48PPN)
      MV2_COLL_TUNING_FINISH_TABLE (scatter)
    }
    else {

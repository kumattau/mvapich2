...
int MV2_set_alltoall_tuning_table(int heterogeneity)
{
  ...
  int i;
    ...
    MV2_COLL_TUNING_ADD_CONF     (alltoall, 4,  1, GEN2__RI2__4PPN)
    MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 4,  1, GEN2_CMA__RI2__4PPN)
    MV2_COLL_TUNING_ADD_CONF     (alltoall, 8,  4, GEN2__RI2__8PPN)
    MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 8,  4, GEN2_CMA__RI2__8PPN)
    MV2_COLL_TUNING_ADD_CONF     (alltoall, 16, 4, GEN2__RI2__16PPN)
    MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 16, 3, GEN2_CMA__RI2__16PPN)
	...
	*/
	...
	MPIU_Memcpy(mv2_alltoall_indexed_thresholds_table[i], table_ptrs[i],
      ...
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 1,  4, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 2,  5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__2PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 4,  5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 8,  5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__8PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 16, 5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 24, 5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__24PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 48, 5, PSM__INTEL_PLATINUM_8160_2S_48_INTEL_HFI_100__48PPN)
      MV2_COLL_TUNING_FINISH_TABLE (alltoall)
    }
    else {

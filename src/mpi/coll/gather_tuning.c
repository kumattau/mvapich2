...
int MV2_set_gather_tuning_table(int heterogeneity)
{
  ...
  if (mv2_use_indexed_tuning || mv2_use_indexed_gather_tuning) {
	...
	MPIU_Memcpy(mv2_gather_indexed_thresholds_table[i], table_ptrs[i],
      ...
      MV2_COLL_TUNING_ADD_CONF     (gather, 4,  1, GEN2__RI2__4PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (gather, 4,  1, GEN2_CMA__RI2__4PPN)
	...
	PSM__INTEL_XEON_E5_2695_V3_2S_28_INTEL_HFI_100__4PPN;
      ...
      mv2_gather_indexed_table_ppn_conf[3] = 28;
      mv2_size_gather_indexed_tuning_table[3] = 5;
      mv2_gather_indexed_tuning_table mv2_tmp_gather_indexed_thresholds_table_28ppn[] =
	PSM__INTEL_XEON_E5_2695_V3_2S_28_INTEL_HFI_100__28PPN;
      table_ptrs[3] = mv2_tmp_gather_indexed_thresholds_table_28ppn;
	...
	MPIU_Memcpy(mv2_gather_indexed_thresholds_table[i], table_ptrs[i],
      ...
      /* Jade/Opal Table */
      MV2_COLL_TUNING_START_TABLE  (gather, 2)
      ...
      MV2_COLL_TUNING_ADD_CONF     (gather, 4,  5, PSM__INTEL_XEON_PHI_7250_68_INTEL_HFI_100__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (gather, 16, 4, PSM__INTEL_XEON_PHI_7250_68_INTEL_HFI_100__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (gather, 64, 3, PSM__INTEL_XEON_PHI_7250_68_INTEL_HFI_100__16PPN)
      MV2_COLL_TUNING_FINISH_TABLE (gather)
    }
    else {
      /*Sierra Table*/
